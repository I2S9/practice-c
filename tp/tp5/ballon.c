...
void afficher(donnees_t donnees)
{
    ...
    tracerSegment(donnees.modele.main.p.x, donnees.modele.main.p.y, donnees.modele.ballon.o.p.x, donnees.modele.ballon.o.p.y);
    selectionnerStylo(donnees.stylos.main);
    tracerPoint(donnees.modele.main.p.x, donnees.modele.main.p.y);
...
void effacer(donnees_t donnees)
{
    ...
    selectionnerStylo(donnees.stylos.main);
    effacerPoint(donnees.modele.main.p.x, donnees.modele.main.p.y);
    selectionnerStylo(donnees.stylos.ficelle);
    effacerSegment(donnees.modele.main.p.x, donnees.modele.main.p.y, donnees.modele.ballon.o.p.x, donnees.modele.ballon.o.p.y);
...
void mettre_a_jour(donnees_t * donnees)
{
    ...
    donnees->modele.main.p.x = esc.sourisX;
    donnees->modele.main.p.y = esc.sourisY;
}
